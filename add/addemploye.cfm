			...
			<div class="row mb-3">
				...
				<div class="col-sm-10 ">
					<select class="form-select"  id="select" aria-label="Default select example" name="selection" >
						...
						<option value="0"<cfif sel eq 0>selected</cfif>>DIPLOMA</option>
						<option value="1"<cfif sel eq 1>selected</cfif>>GRADUATE</option>
						<option value="2"<cfif sel eq 2>selected</cfif>>POST GRADUATE</option>
